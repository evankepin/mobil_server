...
$routes->post('mobil/store', 'Mobil::storeData'); // Route untuk menyimpan data mobil
$routes->get('mobil/show', 'Mobil::show');
...
$routes->post('mobil/update/(:num)', 'Transaksi::update/$1'); // Route untuk mengupdate data berdasarkan id
